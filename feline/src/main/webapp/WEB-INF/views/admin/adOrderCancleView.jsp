	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 col-8 align-self-center">
				<h3 class="text-themecolor">주문취소 상세보기</h3>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="/feline/admin/main.cat">관리자 메인</a>
					</li>
					<li class="breadcrumb-item"><a href="adOrderCancleList.cat">주문취소 목록</a></li>
					<li class="breadcrumb-item active">주문취소 상세보기</li>
				</ol>
			</div>
		</div>
		<!-- ////////////////////////////////////////body 내용/////////////////////////////////// -->
				...
				<div class="card">
					<div class="card-block">
						<div class="form-group">
							<div class="row">
								<div class="col-md-4">
									<label class="col-md-5">취소번호</label>
									<div class="col-md-8">
										<input type="text" readonly="readonly"
											value="${cancleModel.cancle_num}"
						...
						<div class="form-group">	
							<div class="row">
								<div class="col-md-4">
									<label class="col-md-5">취소이유</label>
									<div class="col-md-8">
										<input type="text" readonly="readonly"
											value="${cancleModel.cancle_reason}"
											class="form-control form-control-line">
									</div>
								</div>
							</div>
