	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 col-8 align-self-center">
				<h3 class="text-themecolor">주문교환 상세보기</h3>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="/feline/admin/main.cat">관리자 메인</a>
					</li>
					<li class="breadcrumb-item"><a href="adOrderRefundList.cat">주문교환 목록</a></li>
					<li class="breadcrumb-item active">주문교환 상세보기</li>
				</ol>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-block">
						<div class="form-group">
							<div class="row">
								<div class="col-md-4">
									<label class="col-md-5">교환번호</label>
									<div class="col-md-8">
										<input type="text" readonly="readonly"
											value="${changeModel.change_num}"
						...
						<div class="form-group">	
							<div class="row">
								<div class="col-md-7">
									<label class="col-md-7">교환 이유</label>
									<div class="col-md-14">
										<input type="text" readonly="readonly"
											value="${changeModel.change_reason}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="col-md-4">
									<label class="col-md-5">교환 상태</label>
									<div class="col-md-12">
										<c:choose>
											<c:when test="${changeModel.change_state == 0 }">
												<c:set var="result" value="교환대기중" />
											</c:when>
											<c:when test="${changeModel.change_state == 1 }">
												<c:set var="result" value="교환수락" />
											</c:when>
											<c:otherwise>
												<c:set var="result" value="교환거절" />
											</c:otherwise>
										</c:choose>
										<input type="text" readonly="readonly"
											value="${result}"
