						...
						<c:choose>
							...
							<c:otherwise>
								<ul class="nav nav-pills nav-stacked">
									...
									<i class="fa fa-times"></i>주문 취소 내역</a></li>	
									<li class="active"><a href="b_orderRefundList.cat?order_trade_num=${order_trade_num}">
									<i class="fa fa-toggle-on"></i>주문 환불 내역</a></li>	
					...
					<div class="box">
						<h3>
							<c:choose>
								...
								<c:otherwise>환불내역 <small>비회원전용</small></c:otherwise>
							</c:choose>
						</h3>
						<legend>
							<h2>주문 환불 리스트</h2>
						...
						<table class="table table-hover">
							...
							<c:forEach var="order" items="${orderRefundList}" varStatus="status">
								<tr>
									...
									<td><a href="orderRefundView.cat?order_num=${order.order_num}">${order.order_num }</td></a>
