			...
			<!-- ========================================================================================== -->
				...
				<!-- ========================================================================================== -->
						<center><c:choose>
							...
							onclick="javascript:location.href='orderRefundList.cat'">목록</button>
							</c:when>
							<c:otherwise>
							<button class="btn btn-primary" type="button" 
							onclick="javascript:location.href='b_orderRefundList.cat?order_trade_num=${cancleModel.order_trade_num}'">목록</button>
							</c:otherwise>
						</c:choose><center>					
					</div>
				</div>
