...
<!-- styles -->
<link href="/feline/resources/common/css/font-awesome.css"
	rel="stylesheet">
<link href="/feline/resources/common/css/bootstrap.min.css"
	rel="stylesheet">
<link href="/feline/resources/common/css/animate.min.css"
	rel="stylesheet">
<link href="/feline/resources/common/css/owl.carousel.css"
	rel="stylesheet">
<link href="/feline/resources/common/css/owl.theme.css" rel="stylesheet">
<link rel="stylesheet"
	href="httpc://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

<!-- theme stylesheet -->
<link href="/feline/resources/common/css/style.default.css"
...
<body bgcolor="#f5f5f5">
	<div id="all">
		<div id="content">
			<div class="container">
				<div class="col-md-12">
					<%-- 만약 checkNumb이 0이면 입력한 정보와 일치하는 PW가 없는 것이기 때문에 다시 실행한다. --%>
					<c:choose>
					<c:when test="${checkNum eq 1}">
						<div class="box">
							<div class="rTable" width="100%" border=0>
								<div class="form-group" align="center">
									<font size="2">찾으신 비밀번호는 ${member_pw} 입니다.</font> <br /> <br />
									<button type="button" class="btn btn-primary"
										onclick="windowclose()">닫기</button>
								</div>
							</div>
						</div>
					</c:when>
