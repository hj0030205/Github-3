...
<script language="javascript">
	function check() {
		 var email = joincheck.member_email.value;
	      if (!document.getElementById("use").checked) {
	         alert("쇼핑몰 이용약관에 동의하지 않으셨습니다.");
	         return false;
	      }
	      ...
	      window.open("EmailCheck.cat?&member_email="
	               + document.joincheck.member_email.value, "checkEmailForm",
	               "width=500,height=300,resizable=no,scrollbars=no");
	      }
	   }

	function toggle(source) {
		var checkboxes = document.getElementsByName('promise');
...
제1조(목적)
이 약관은 (팀)혼자왔조(세미프로젝트 팀)가 운영하는 FELINE 쇼핑몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 (팀)혼자왔조가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 (주)모나미 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
본 약관은 2018년5월04일부터 적용됩니다.
 ...
 FELINE는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립. 공개합니다. 
...
제1조(개인정보의 처리목적) 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다. 
 ...
 제14조(개인정보 처리방침 변경) ① 이 개인정보 처리방침은 2018. 5. 4부터 적용됩니다.
								...
								<div class="Join">
									<div class="inner">
										...
										<div class="checkbox" style="margin-left: 10px">
											<input type="checkbox" onclick="toggle(this);"/>전체동의 <br>
											<br> <input type="checkbox" name="promise" id="use"/>쇼핑몰 이용약관동의
											<br> <br /> <input type="checkbox" name="promise"
												id="collect"/>개인정보 처리 약관 동의<br />
										</div>
									</div>
								</div>
							</div>
